...
select cron.schedule('market-agent-stories', '16 6,9,12,16 * * *', $job$
...
-- Four boards a day. The hours are UTC and chosen so they stay inside
-- active hours on BOTH sides of the clock change: 06,09,12,16 UTC is
-- 09,12,15,19 local in summer and 08,11,14,18 in winter. Every gap is
-- at least three hours, well clear of MIN_MINUTES_BETWEEN_STORIES
-- (75), so a slot that starts late still tells its hour instead of
-- refusing itself.
--
